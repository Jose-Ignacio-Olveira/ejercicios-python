...
class Persona:
    def __init__(self, nombre:str, apellido:str, edad:int, sexo:str, trabaja:bool, estudia:bool, puesto: Puesto):
    ...
    def get_puesto(self):
        return self.__puesto.get_nombre()
    
    def set_puesto(self,puesto:Puesto):
        self.__puesto = puesto
